...
if [[ ${PRJ_NAME} = "apps" ]]; then	
	...
	echo -e "  $(ksln_local_ln ${APP_PATH} "Dossier de vos applications Web")\n\n"

	echo -e "  ${DIM}Création & Modifications${NC}\t${GREEN}1${NC}. Assembler\t${GREEN}2${NC}. Modifier\t${RED}3${NC}. Éteindre\n"
...
# HEADER
	...
	ksln_subheader "DOCUMENTATION > " "ÉTEINDRE"
