...
# Catalogue des réalisations avec Konnect


<!--- 1. Modifier la source (src) afin qu'elle indique le lien de votre catalogue-->

<iframe class="iframe-forge" src="/catalogues/exemple/catalogue" width="100%" height="100%" frameborder="0" loading="lazy"></iframe>
...
function CatalogBack() {
        window.location.href = "https://konsilion.fr";
    }
</script>
